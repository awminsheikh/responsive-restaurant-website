...
for (let y = 0; y < swiperSlide.length; y++) {
    swiperSlide[y].addEventListener("click", (event) => {
        ...
        else if (swiperClass.contains("swiper-card")) {
            targetCategory = event.target.parentElement;
        }
        else if (swiperClass.contains("category-img")) {
            targetCategory = event.target.parentElement.parentElement;
        }
        else if (swiperClass.contains("category-title")) {
            targetCategory = event.target.parentElement.parentElement;
        }
        else if (swiperClass.contains("category-image")) {
